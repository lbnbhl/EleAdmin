...
public class CodeGenerator {
    ...
    // 数据库连接配置
    private static final String DB_URL = "jdbc:mysql://localhost:3307/ele-admin-api?useUnicode=true&useSSL=false&characterEncoding=utf8";
    private static final String DB_DRIVER = "com.mysql.cj.jdbc.Driver";
    private static final String DB_USERNAME = "root";
    private static final String DB_PASSWORD = "wwl04212430";
    // 包名
